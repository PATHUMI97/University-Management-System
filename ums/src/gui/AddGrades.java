...
public class AddGrades extends javax.swing.JFrame {
 ...
 combobox1();
    ...
    public void combobox1() {
       ...
       public void combobox2(String crs) {
        String query1 = "SELECT * FROM `subjects` WHERE course =?";

        try {

            PreparedStatement psm1 = conn.prepareStatement(query1);
psm1.setString(1, crs);
            ResultSet rs1 = psm1.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tmark = jTextField3.getText();
        String pmark = jTextField4.getText();

        String result = GradesModel.updateSubject(nic,crs, subname, tmark, pmark);
    ...
    combobox2(jComboBox3.getSelectedItem().toString());
