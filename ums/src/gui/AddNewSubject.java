...
public SubjectModel SubjectModel;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String result = SubjectModel.insertSubject(subid,subname,sem,course);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String subid =jTextField1.getText();
                String result = SubjectModel.deleteSubject(subid);
        JOptionPane.showConfirmDialog(this, result, "Message  ", -1, 1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String subid =jTextField1.getText();
        ...
        String result = SubjectModel.updateSubject(subid,subname,sem,course);
        JOptionPane.showConfirmDialog(this, result, "Message  ", -1, 1);
