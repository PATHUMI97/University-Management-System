 ...
 * @author PATHUMI
 */
public class CourceEnrollment extends javax.swing.JFrame {
    Connection conn;
...
String result = courceModel.createRollNo(code,sem,rollno);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CourceEnrollment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
